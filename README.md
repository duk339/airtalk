...
## サイト概要
### サイトテーマ
航空会社のレビューを検索したり、投稿できるレビューサイト
<!-- - 〜なコミュニティサイトorレビューサイトorSNS　と１文で記載する -->
​
### テーマを選んだ理由
自分の趣味は旅行です。旅行先では観光費に費用を充てたいため、移動費を安く済ませたいと考えています。
そのため色々な航空会社を検索するのですが、不要な情報が多かったり必要な情報が少なかったりと、精査が難しいです。
その口コミが分かればいい面や注意点など予約するときの参考になると思いました。
